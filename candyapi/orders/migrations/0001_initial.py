    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intervals', models.ManyToManyField(to='couriers.Interval')),
                ('region', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='couriers.region')),
            ],
        ),
    ]
